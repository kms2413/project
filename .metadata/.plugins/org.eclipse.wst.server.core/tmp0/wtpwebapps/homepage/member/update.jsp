         ...
         <form class=border_doc name="memberForm" action="updateOk.jsp" method="post" onsubmit="return registerForm(this)">
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span>*<input type="text" name="id"  size="30" value = "<%=dto.getId()%>" readonly/></span>
               </div>
            </div>   
            ...
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span>*<input type="password" name="password" value = "<%=dto.getPassword() %>" size="30"/></span>
               </div>
            </div>
            ...
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span>*<input type="password" name="passwordCheck" value = "<%=dto.getPassword() %>" size="30"/></span>
               </div>
            </div>
            ...
            <div class=border_div>   
               ...
               <div class=border_box_right>
                  <span>*<input type="text" name="name" value = "<%=dto.getName() %>" size="30" readonly/></span>
               </div>
            </div>
            ...
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span>*<input type="text" name="jumin1"value = "<%=dto.getJumin1() %>"  size="20" readonly/></span>
                  <span>-<input type="text" name="jumin2"value = "<%=dto.getJumin2() %>"  size="20" readonly/></span>
               </div>
            </div>
            ...
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span><input type="text" name="email" value = "<%=dto.getEmail() %>" size="30"/></span>
               </div>
            </div>
            ...
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span><input type="text" name="zipcode" value = "<%=dto.getZipcode()%>" size="30"/></span>
            ...
            <div class=border_div>
               ...
               <div class=border_box_right>
                  <span><input type="text" name="address" value = "<%=dto.getAddress()%>" size="50"/></span>
               </div>
            </div>
