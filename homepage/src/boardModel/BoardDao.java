...
public class BoardDao {
   ...
   public int insert(BoardDto board){
      ...
      //System.out.println(board.getGroupNumber() + "," + board.getSequenceNumber() + "," + board.getSequenceLevel());
      try{
   ...
   public void writeNumber(Connection conn, BoardDto board){
      //�뙴�뫂�뱜(域밸챶竊숃린�뜇�깈, 疫뀐옙占쎈떄占쎄퐣, 疫뀐옙占쎌쟿甕곤옙), 占쎈뼗疫뀐옙(域밸챶竊숃린�뜇�깈, 疫뀐옙占쎈떄占쎄퐣, 疫뀐옙占쎌쟿甕곤옙)
